...
type GenerateRedeemCodesRequest struct {
	...
	Type          string     `json:"type" binding:"required,oneof=balance balance_reset concurrency subscription invitation"`
...
type CreateAndRedeemCodeRequest struct {
	...
	Type          string     `json:"type" binding:"omitempty,oneof=balance balance_reset concurrency subscription invitation"` // 不传时默认 balance（向后兼容）
