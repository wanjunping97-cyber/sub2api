export default {
    ...
    users: {
      ...
      balanceResetDueFilter: 'Next Reset',
      allBalanceResetDue: 'All reset cycles',
      balanceResetDueOverdue: 'Overdue',
      balanceResetDueSoon: 'Due soon',
      nextResetOverdue: 'Overdue',
      nextResetDueSoon: 'Due soon',
      nextResetHint: 'After a reset-balance redeem, the next natural reset is 7 days later so you can run it then',
      ...
      typeBalanceReset: 'Balance Reset (Redeem)',
