export default {
  ...
  redeem: {
    ...
    nextResetAt: 'Next natural reset: {time}',
    ...
    codeRule6: 'After redeeming a reset-balance code, the next natural reset is 7 days later',
    recentActivity: 'Recent Activity',
    historyWillAppear: 'Your redemption history will appear here',
    balanceAddedRedeem: 'Balance Added (Redeem)',
    balanceResetRedeem: 'Balance Reset',
  ...
  profile: {
    ...
    readonlyAdministrator: 'Read-only administrator',
    user: 'User',
    username: 'Username',
    email: 'Email',
    status: 'Status',
